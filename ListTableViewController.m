...
-(void)selecttel
{
    self.list = [Post getSynchronousRequestDataJSONSerializationWithURL:@"http://www.boea.cn/m_hmw/business/czyy/deliverynote.aspx" withHTTPBody:[NSString stringWithFormat:@"tel=%@",self.tel.text]];
